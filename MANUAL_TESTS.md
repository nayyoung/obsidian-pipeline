...
**Setup:** Export a conversation from ChatGPT (JSON format) and save to:
`~/ObsidianVault/00-Inbox/chatgpt/2024-12-07-chatgpt-export.txt`
...
**Setup:** Copy-paste a Gemini conversation to:
`~/ObsidianVault/00-Inbox/gemini/2024-12-07-gemini-chat.txt`
...
**Setup:**
1. Edit `~/ObsidianVault/06-Bibles/Gumroad_Launch_Bible.md` with specific project context
...
1. Open `~/ObsidianVault` as a vault in Obsidian
2. Navigate to `01-Processed/` folder
